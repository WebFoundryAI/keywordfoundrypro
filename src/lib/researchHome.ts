...
export async function getOrCreateUserResearchHome(
  ...
  // For now, always redirect to the main keyword research page
  // Research spaces feature is not fully implemented yet
  return '/app/keyword-research';

  // TODO: Implement research spaces when ready
